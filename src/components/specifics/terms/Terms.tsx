...
const Terms: React.FC = () => (
  <Section>
    ...
    <p>
      ...
      type of device you’re using and your IP address. They are usually used to
      fix application errors but may be used for advertising in the future.
    </p>
    <p>
      We use <a href="https://firebase.google.com/">Firebase</a> for application
      hosting and authentication. Please check the official website for the
      service.
    </p>
    <p>
